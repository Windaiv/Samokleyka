...
<script type="text/javascript">
				$(document).ready(function () {	
					...
					var qt = parseFloat($("#product-size").attr("value1"));
					...
					$("#product-quantity").change(function() {
						...
						qt = parseFloat($("#product-size").attr("value1"));
						totalPrice = qty * qt;
						$("#product-total-price").empty();
						$("p.price-top").empty();
						$("#product-total-price").append(totalPrice + " руб");
...
<a href="http://www.samokleyka.net/albom4/<?=$back?>.php">
...
<a href="http://www.samokleyka.net/albom4.php">
