...
<link rel="icon" href="http://www.samokleyka.net/favicon.gif"/>
 ...
 <meta name="Description" content="Интернет-каталог наклеек для всех, <?=$namefoto?> из нашего каталога для Вашего неповторимого образа!"/>
 <meta name="Keywords" content="Интернет-каталог наклеек для всех, <?=$namefoto?> из нашего каталога для Вашего неповторимого образа!"/>
...
<h1><?=$namefoto?></h1>
<p class="price-top">&nbsp;500 руб.&nbsp;</p>
</div>
	<!-- *контент flash* -->
<?php include("../templates/Blocks/flash_m.html");?>
...
<div id="options-content">
	...
	<!-- *контент options* -->
<?php include("../templates/Blocks/options_m.html");?>
...
<option value="44-46" value1="500">Мужская-(S)-44-46</option>
<option value="46-48" value1="500">Мужская-(M)-46-48</option>
<option value="48-50" value1="500">Мужская-(L)-48-50</option>
<option value="50-52" value1="500">Мужская-(XL)-50-52</option>
<option value="50-54" value1="500">Мужская-(XXL)-52-54</option>
<option value="42-44" value1="500">Женская-(S)-42-44</option>
<option value="44-46" value1="500">Женская-(M)-44-46</option>
<option value="46-48" value1="500">Женская-(L)-46-48</option>
<option value="48-50" value1="500">Женская-(Xl)-48-50</option>
<option value="50-52" value1="500">Женская-(XXL)-50-52</option>
</select>
<p class="option-infos">* Если Вы желаете внести изменения, звоните!</p>			
...
<div id="product-image" align="center"><img src="images/<?=$idnomer?>.jpg" alt="Большой пример майки" /></div>
	</div>
<br>
<table width="100%">
<tr>
<td width="50%" align="left">
<a href="http://www.samokleyka.net/albom15.php">
<img src="http://www.samokleyka.net/templates/Modification/images/buttons/french/catalog.png"
alt="Каталог" width="103" height="43" border="0" /></a>
</td>
<td  width="50%" align="right">
<a href="http://www.samokleyka.net/albom15/<?=$next?>.php">
