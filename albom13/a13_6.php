...
<option value="27"  alt="0.0000">тёмно-красный </option>
</select>
<label>Материал:</label><select name="mat" class="mat"><option value="2"  alt="0.0000">глянцевый </option></select>
...
<option value="30x38" value1="180">30x38 см.</option>
</select>
...
<a href="http://www.samokleyka.net/albom13/<?=$back?>.php">
...
<a href="http://www.samokleyka.net/albom13.php">
