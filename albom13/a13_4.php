...
<option value="50"  alt="0.0000">серебристо-серый </option>
</select>
<label>Материал:</label><select name="mat" class="mat"><option value="1"  alt="0.0000">матовый </option></select>
<label>Положение:</label><select name="pol" class="change-side"><option value="57"  alt="0.0000">нормальное </option><option value="58"  alt="0.0000">зеркальное </option></select>
...
<option value="20x80" value1="200">20x80 см.</option>
</select>
...
<a href="http://test.vedrov.ru/samokleyka/albom13/<?=$back?>.php">
...
<a href="http://test.vedrov.ru/samokleyka/albom13/<?=$next?>.php">
