...
<h1><?=$namefoto?></h1>
<p class="price-top">&nbsp;360 руб.&nbsp;</p>
</div>
	<!-- *контент flash* -->
<?php include("../templates/Blocks/flash_full.html");?>
...
<div id="options-content">
	...
	<!-- *контент options* -->
<?php include("../templates/Blocks/options_full.html");?>
<input type="hidden" name="notebooke" value="notebooke">
...
<option value="26,7x20,9" value1="360">12" ноутбук (26,7x20,9 см.)</option>
<option value="31,5x21,7" value1="360">13" Macbook Air (31,5x21,7 см.)</option>
<option value="31,5x21,7" value1="360">13,3" ноутбук (31,5x21,7 см.)</option>
<option value="31,3x24,9" value1="360">14" ноутбук (31,3x24,9 см.)</option>
<option value="34,1x24,3" value1="360">15" ноутбук (34,1x24,3 см.)</option>
<option value="34,1x23,3" value1="360">15,4" ноутбук (34,1x23,3 см.)</option>
<option value="38,2x24,9" value1="360">17" ноутбук (38,2x24,9 см.)</option>
</select>
<p class="option-infos">* Если Вы желаете изменить размер, звоните или оставляйте комментарий!</p>			
...
<a href="http://www.samokleyka.net/albom11/<?=$next?>.php">
