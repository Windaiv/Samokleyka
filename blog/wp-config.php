...
define('DB_NAME', 'z134086_shop');

/** MySQL имя пользователя */
define('DB_USER', 'z134086_shop');

/** MySQL пароль базы данных */
define('DB_PASSWORD', '1690255');
 ...
 * @since 2.6.0
 */
define('AUTH_KEY', 'Shla masha po shosse i sosala sushku');
define('SECURE_AUTH_KEY', 'Sushku masha sosala i shla po shosse');
define('LOGGED_IN_KEY', 'Privet Maidodir');
define('NONCE_KEY', 'Russia dtkbrfz cnhfyf');
/**#@-*/
